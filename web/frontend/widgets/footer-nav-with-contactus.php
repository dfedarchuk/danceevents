                                            ...
                                            <?php if ($contactInfoStr) { ?>
                                                <div itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
                                                    ...
                                                    <?php if ($contact_address) { ?>
                                                        <span itemprop="streetAddress"><?=$contact_address?></span>
                                                    <?php } ?>
                                                    <?php if ($contact_city) { ?>
                                                    ...
                                                    <?php if ($contact_country) { ?>
                                                        <span itemprop="addressCountry"><?=$contact_country?></span>
                                                    <?php } ?>
                                                </div>
                                            <?php } ?>
                                ...
                                <div class="col-sm-3 col-xs-6">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <?php if ($setting_linkedin_link) { ?>
                                            <li>
                                                <a target="_blank" href="<?=$setting_linkedin_link?>" class="social-links"><span class="fa fa-linkedin"></span> Linkedin </a>
                                            </li>
                                        <?php } ?>
                                        <?php if ($setting_twitter_link) { ?>
                                            <li>
                                                <a target="_blank" href="<?=$setting_twitter_link?>" class="social-links"><span class="fa fa-twitter"></span> Twitter </a>
                                            </li>
                                        <?php } ?>
