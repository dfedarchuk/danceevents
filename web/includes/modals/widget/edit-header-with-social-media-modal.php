<!-- edit header with social media modal -->
<?php
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h4 class="subtitle">
                        <?= system_showText(LANG_SITEMGR_LABEL_SOCIAL_NETWORKS); ?>
                    </h4>
                    <form class="form" id="form_social_header" name="form_social_header">
            ...
            <div class="row">
                <div class="col-xs-12 text-right">
                    ...
                    <button type="button" class="btn btn-primary btn-lg action-save" data-loading-text="<?=system_showText(LANG_LABEL_FORM_WAIT);?>"
                            onclick="<?= DEMO_LIVE_MODE ? "livemodeMessage(true, false);" : "saveWidget('header-with-social-media');" ?>"><?= system_showText(LANG_SITEMGR_SAVE_CHANGES); ?></button>
                </div>
            </div>
