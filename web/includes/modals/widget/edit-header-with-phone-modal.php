...
<div class="modal-dialog modal-lg widget-header" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="add-favicon">
                <div class="add-favicon-tab">
                    <form name="form_favicon" id="form_favicon">
                        <? if (file_exists($favIconFile[0])) { ?>
                            <div class="edit-hover">
                                <a href="#" class="favIconButton">
                                    <img
                                        id="favIconImg"
                                        src="<?= str_replace(EDIRECTORY_ROOT, DEFAULT_URL,
                                            $favIconFile[0]) ?>?<?= rand(0, 1000) ?>"
                                        alt="Favicon">
                                </a>
                        ...
                        <? } ?>
                        <input type="file" id="favIconInput" name="favicon_file" style="display: none;"
                               onchange="saveImage('form_favicon', 'favicon', 'favIconImg', 'form_favicon', null, 'messageAlertHeader')">
                    </form>
                </div>
                <p class="help-block">
            ...
            <form id="datainfoDivHeader">
                <h4 class="subtitle">
                    <?= system_showText(LANG_SITEMGR_LABEL_PHONE); ?>
                </h4>
                <div class="form-group">
                    <input type="tel" class="form-control" id="datainfoContactPhoneHeader"
                           name="datainfoContactPhoneHeader"
                           value="<?= $content['datainfoContactPhoneHeader'] ?>"
