    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <form id="datainfoDivFooter">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="5" class="form-control" name="datainfoContactAddress"
                                   id="datainfoContactAddress"
                                   placeholder="<?= system_showText(LANG_SITEMGR_CONTACTUS_ADDRESS); ?>"
                                   value="" <?= ($loadMap ? "onblur=\"loadMap();\"" : "") ?>><?= $content['datainfoContactAddress']?></textarea>
                        </div>
                        <div class="form-group">
                            <label for="datainfoContactPhone" class="control-label">
                                <?= system_showText(LANG_SITEMGR_LABEL_PHONE);?>
                            </label>
                            <input type="tel" class="form-control" id="datainfoContactPhone"
                                   name="datainfoContactPhone"
                ...
                <div class="col-md-5">
                    <h4 class="subtitle"><?= system_showText(LANG_SITEMGR_SETTINGS_NAVIGATION); ?>
