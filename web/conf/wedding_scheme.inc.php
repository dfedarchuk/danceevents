<?
	...
	//set default scheme
	$edir_default_scheme = "wedding";

	//set all available schemes separated by comma
	$edir_schemes = "wedding";
	$edir_schemenames = "Wedding";

	//code to setup one specific scheme from all available schemes
	$edir_scheme = "wedding";

	if (DEMO_LIVE_MODE == 0) {
		@include_once(EDIRECTORY_ROOT.'/custom/domain_'.SELECTED_DOMAIN_ID.'/theme/wedding_scheme.inc.php');
	} else {
