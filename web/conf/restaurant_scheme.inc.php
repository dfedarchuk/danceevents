<?
	...
	//set default scheme
	$edir_default_scheme = "restaurant";

	//set all available schemes separated by comma
	$edir_schemes = "restaurant";
	$edir_schemenames = "Restaurant Guide";

	//code to setup one specific scheme from all available schemes
	$edir_scheme = "restaurant";

	if (DEMO_LIVE_MODE == 0) {
		@include_once(EDIRECTORY_ROOT.'/custom/domain_'.SELECTED_DOMAIN_ID.'/theme/restaurant_scheme.inc.php');
	} else {
